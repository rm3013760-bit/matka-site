...
perl -e 'alarm 90; exec @ARGV' git -c credential.helper= -c http.lowSpeedLimit=1000 -c http.lowSpeedTime=30 push -q "https://oauth2:${GITTOKEN}@github.com/rm3013760-bit/matka-site.git" master 2>"$DIR/server/actions/push.err" \
